...
export const faqContent = {
    ko: {
        ...
        items: [
            ...
            { q: '광고가 표시되나요? 서비스가 유료화되나요?', a: '현재 홈 화면에는 광고 영역을 표시하지 않습니다. 카드 생성 기능은 앞으로도 무료로 제공할 예정입니다.' },
    ...
    en: {
        ...
        items: [
            ...
            { q: 'Are ads displayed, and will the service become paid?', a: 'The home screen does not currently display an advertising area. Card creation and its core features are planned to remain free.' },
    ...
    ja: {
        ...
        items: [
            ...
            { q: '広告は表示されますか？サービスは有料になりますか？', a: '現在、ホーム画面に広告エリアは表示していません。カード作成と主要機能は今後も無料で提供する予定です。' },
